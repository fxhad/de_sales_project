...
#AKIAW3MEAQNW5SAE7UH7
#b'xS+BuTV+rpDUIhwxFMi8+mvIqnKWZ0lyqlypyOL5t3c='

print(encrypt('AKIAW3MEAQNW5SAE7UH7'))
print(encrypt('N9bu2F/5Qtdj+gEZPKPZcNAHxIUtZvbEa9vwZqnb'))
